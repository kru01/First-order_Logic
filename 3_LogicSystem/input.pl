...
/* Rules */
husband(Person, Wife) :- male(Person), female(Wife), married(Person, Wife), married(Wife, Person).

wife(Person, Husband) :- female(Person), male(Husband), married(Person, Husband), married(Husband, Person).
